...
public class ConnectSQL {
    ...
    public ConnectSQL() {
        try {
            connect = DriverManager.getConnection("jdbc:mysql://localhost:3306/cafe_manager", "root", "quanghuy123");
            System.out.println("Kết nối SQL thành công!");
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(null, "Kết nối tới SQL thất bại: \n" + ex.getMessage());
